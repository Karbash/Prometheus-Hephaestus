...
public class AdditionalController : ControllerBase
{
    ...
    [HttpPut("{id}")]
    [SwaggerOperation(Summary = "Atualiza um adicional", Description = "Atualiza as informa��es de um adicional existente, se ele pertencer ao tenant do usu�rio autenticado.")]
